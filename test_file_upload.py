...
from app.utils.file_handlers import extract_pdf_content, extract_docx_content, extract_file_content
...
def create_test_docx_file():
    ...
    doc.add_paragraph("It contains multiple paragraphs to test the extraction functionality.")
    doc.add_paragraph("")
