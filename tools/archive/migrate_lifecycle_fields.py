...
def migrate_tables():
    ...
    try:
        ...
        if "last_active" not in user_columns:
            ...
            cursor.execute(
                f"ALTER TABLE users ADD COLUMN last_active TEXT DEFAULT '{get_current_time()}'"
            )
            changes_made = True
        ...
        if "created_at" not in course_columns:
            ...
            cursor.execute(
                f"ALTER TABLE courses ADD COLUMN created_at TEXT DEFAULT '{get_current_time()}'"
            )
            changes_made = True
        ...
        if "updated_at" not in course_columns:
            ...
            cursor.execute(
                f"ALTER TABLE courses ADD COLUMN updated_at TEXT DEFAULT '{get_current_time()}'"
            )
            changes_made = True
        ...
        if "created_at" not in assignment_columns:
            ...
            cursor.execute(
                f"ALTER TABLE assignments ADD COLUMN created_at TEXT DEFAULT '{get_current_time()}'"
            )
            changes_made = True
        ...
        if "updated_at" not in assignment_columns:
            ...
            cursor.execute(
                f"ALTER TABLE assignments ADD COLUMN updated_at TEXT DEFAULT '{get_current_time()}'"
            )
            changes_made = True
