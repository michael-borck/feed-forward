...
def init_db():
    ...
    default_methods = [
        ...
        {"name": "Weighted Mean", "description": "Weighted average based on model confidence"}
    ]
        ...
        try:
            ...
            for m in aggregation_methods():
                if m.name == method["name"]:
                    ...
                    break
            if not existing:
                aggregation_methods.insert(AggregationMethod(
            ...
            print(f"  Note: {method['name']} - {str(e)}")
    ...
    default_styles = [
        ...
        {"name": "Analytical", "description": "Detailed analysis with specific examples"},
        {"name": "Balanced", "description": "Mix of positive reinforcement and constructive criticism"}
    ]
        ...
        try:
            ...
            for s in feedback_styles():
                if s.name == style["name"]:
                    ...
                    break
            if not existing:
                feedback_styles.insert(FeedbackStyle(
        ...
        try:
            ...
            for o in mark_display_options():
                if o.name == option["name"]:
                    ...
                    break
            if not existing:
                mark_display_options.insert(MarkDisplayOption(
            ...
            print(f"  Note: {option['name']} - {str(e)}")
    
    # Add example whitelisted domains
    example_domains = [
        {"domain": "example.edu", "institution_name": "Example University", "auto_approve": True},
        {"domain": "test.edu", "institution_name": "Test College", "auto_approve": True}
    ]
        ...
        try:
            ...
            for d in domain_whitelist():
                if d.domain == domain["domain"]:
                    ...
                    break
            if not existing:
                domain_whitelist.insert(DomainWhitelist(
            ...
            print(f"  Note: {domain['domain']} - {str(e)}")
