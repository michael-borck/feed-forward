    ...
    for course_data in sample_courses:
        ...
        for course in courses():
            if (
                ...
                and course.term == course_data["term"]
            ):
                exists = True
    ...
    for course_id in course_ids:
        ...
        for enrollment in enrollments():
            if (
                ...
                and enrollment.student_email == TEST_STUDENT_EMAIL
            ):
                exists = True
        ...
        for j in range(3):  # 3 assignments per course
            ...
            for assignment in assignments():
                if (
                    ...
                    and f"Assignment {j + 1}" in assignment.title
                ):
                    exists = True
            ...
            if not exists:
                ...
                rubric = Rubric(id=next_rubric_id, assignment_id=assignment_id)
                ...
                categories = [
                    ...
                    {
                        "name": "Structure",
                        "description": "Organization and flow of the work",
                        "weight": 30.0,
                    },
                    {
                        "name": "Language",
                        "description": "Clarity and correctness of language",
                        "weight": 30.0,
                    },
                ]
