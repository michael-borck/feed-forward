...
def instructor_dashboard(session, request):
    ...
    sidebar_content = Div(
        ...
        Div(
            ...
            Div(
                action_button("Manage Courses", color="indigo", href="/instructor/courses"),
        ...
        Div(
            ...
            P(f"Total Students: {sum(course_enrollments.values())}", cls="text-gray-600 mb-2"),
            P(f"Total Assignments: {sum(course_assignments.values())}", cls="text-gray-600"),
    ...
    main_content = Div(
        ...
        Div(
            card(
                Div(
                    H3(str(len(instructor_courses)), cls="text-4xl font-bold text-indigo-700 mb-2"),
            ...
            card(
                Div(
                    H3(str(sum(course_enrollments.values())), cls="text-4xl font-bold text-teal-700 mb-2"),
            ...
            card(
                Div(
                    H3(str(sum(course_assignments.values())), cls="text-4xl font-bold text-indigo-700 mb-2"),
                ...
                *(
                    Div(
                        ...
                        status_badge(
                            ...
                            "green" if sub['draft'].status == "feedback_ready" else
                            "yellow" if sub['draft'].status == "processing" else "blue"
                        ),
