...
Return your response in this exact JSON format:
{
    ...
    def _analyze_code_metrics(self, code: str, language: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "comment_lines": sum(1 for line in lines if self._is_comment(line.strip(), language)),
            "code_lines": sum(1 for line in lines if line.strip() and not self._is_comment(line.strip(), language))
        }
