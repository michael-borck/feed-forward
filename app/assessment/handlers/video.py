...
class VideoAssessmentHandler(AssessmentHandler):
    ...
    def validate_submission(self, content: Any, metadata: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
        ...
        if not self._get_video_service():
            return False, "Video assessment service is not configured. Please contact your administrator."
...
Return your response in this exact JSON format:
{
    ...
    def _call_video_service(self, video_path: str, service: AssessmentService, 
